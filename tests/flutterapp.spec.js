...
// test.only("Home Buy Now 3", async ({ page }) => {
//     await page.goto(home_url);
//     const EnvantoStreamitVerifyLocator = page.locator("//div[contains(@class,'elementor-element elementor-element-0ca1a80 elementor-align-center elementor-widget elementor-widget-elementskit-button')]//a[contains(@class,'whitespace--normal')][normalize-space()='Buy Now']");
//     await EnvantoStreamitVerifyLocator.scrollIntoViewIfNeeded();
//     await EnvantoStreamitAppVerify(page, EnvantoStreamitVerifyLocator);
// })

// test.only("Home Buy Now 4", async ({ page }) => {
//     await page.goto(home_url);
//     const LinkLocator = page.locator("//div[contains(@class,'elementor-element elementor-element-53c6c08 elementor-align-center elementor-widget elementor-widget-elementskit-button')]//a[contains(@class,'whitespace--normal')][normalize-space()='Buy Now']");
//     await LinkLocator.scrollIntoViewIfNeeded();
